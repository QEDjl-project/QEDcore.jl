...
conservation laws, facilitating method dispatch in functions like [`_build_momenta`](@ref).
...
# See Also
- [`AbstractInPhaseSpaceLayout`](@ref): A broader type for general incoming phase space layouts.
